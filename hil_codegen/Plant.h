 ...
 * Generated on   : 15 Jun 2022 19:33:02
 */
...
typedef struct
{
   ...
   double Delay;                    /* Plant/Delay */
   double Plant_PM2_x;              /* Plant */
   double Plant_PM3_x;              /* Plant */
   double Plant_PM4_x[39];          /* Plant */
   bool Plant_PM4_s[8];             /* Plant */
...
typedef struct
{
   ...
   double Switch_1[3];              /* Plant/Controller/Sine PWM/ PWM/Configurable Subsystem/Natural/Switch */
   ...
   bool Switch_2;                   /* Plant/Total Harmonic Distortion U/Switch */
   ...
   bool Switch_3;                   /* Plant/Total Harmonic Distortion I/Switch */
   ...
   bool Switch_4;                   /* Plant/Total Harmonic Distortion U1/Switch */
   ...
   bool Switch_5;                   /* Plant/Total Harmonic Distortion I1/Switch */
   ...
   bool Switch_6;                   /* Plant/Total Harmonic Distortion U2/Switch */
   ...
   bool Switch_7;                   /* Plant/Total Harmonic Distortion I2/Switch */
   ...
   bool Switch_8;                   /* Plant/Total Harmonic Distortion U3/Switch */
   ...
   bool Switch_9;                   /* Plant/Total Harmonic Distortion I3/Switch */
